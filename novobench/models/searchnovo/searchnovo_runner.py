...
from .searchnovo_dataloader import SearchnovoDataset, SearchnovoDataModule
from .searchnovo_modeling import Spec2Pep
...
class SearchnovoRunner:
    ...
    def denovo(self, test_df: pl.DataFrame,) -> None:
        ...
        test_loader = SearchnovoDataModule(
            df = test_df,
            n_workers=self.config.n_workers,
